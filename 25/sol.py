...
print("std::vector<char> letters = {%s};" % ", ".join("'%s'" % c for c in blosum62_chars))
print("std::vector<std::vector<int>> penaltyByIdxs = {\n\t%s\n};" % "\n\t".join("{%s}," % ", ".join(map(str, brow)) for brow in blosum62_m))
